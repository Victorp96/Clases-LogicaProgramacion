Subproceso Leer_Datos(Nomb_Vend,Cant_AutVend,Ttal_Vtas)
...
Subproceso Calcular_ComAV(Cant_AutVend,Comis_AV)
	Comis_AV=Cant_AutVend*100000
FinSubProceso

SubProceso Calcular_ComTVtas(Ttal_Vtas,Comis_TVtas)
	Comis_TVtas=Ttal_Vtas*0.18
FinSubProceso

SubProceso Calc_SalNeto(Comis_AV,Comis_TVtas,SalNeto)
